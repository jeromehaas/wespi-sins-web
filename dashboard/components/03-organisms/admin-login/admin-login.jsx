...
const AdminLogin = () => {
	...
	useEffect(() => {
		const context = gsap.context(() => {
			...
			sectionTimelineRef.current.to('.admin-login .admin-login-form', { autoAlpha: 1, top: 0, duration: 0.3 });
		}, sectionRef);
	...
	// RENDER
	return (
		<Section className="admin-login" ref={ sectionRef }>
			<AdminLoginForm className="admin-login__login-form admin-login-form animation--fade-in" />
		</Section>
	);
