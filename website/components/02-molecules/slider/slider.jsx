	...
	useEffect(() => {
		gsap.context(() => {
			...
			if (sliderController.viewportWidth && sliderController.viewportWidth >= 950 && sliderController.direction === 'ltr') {
				...
				sliderController.counter < sliderController.images.length - 0 && sliderTimelineRef.current.to(`.slider__item:nth-child(${ sliderController.counter + 1 })`, { left: 'calc(100% + 80px)' }, 0);
				sliderController.counter < sliderController.images.length - 1 && sliderTimelineRef.current.to(`.slider__item:nth-child(n+${ sliderController.counter + 2 })`, { left: 'calc(200% + 80px)' }, 0);
			};
