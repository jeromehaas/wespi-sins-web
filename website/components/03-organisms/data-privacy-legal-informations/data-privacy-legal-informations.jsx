	...
	return (
		<Section className="data-privacy-legal-informations" ref={ sectionRef }>
			<div className="data-privacy-legal-informations__paragraphs paragraphs animation--fade-in">
				...
				<div className="paragraphs__item item">
					<Paragraph className="item__heading paragraph--bold">Namen und Anschrift der für die Datenverarbeitung Verantwortlichen</Paragraph>
				...
				<div className="paragraphs__item item">
					<Paragraph className="item__heading paragraph--bold">Allgemeines zur Datenverarbeitung</Paragraph>
				...
				<div className="paragraphs__item item">
					<Paragraph className="item__heading paragraph--bold">Bearbeitung von Personaldaten</Paragraph>
				...
				<div className="paragraphs__item item">
					<Paragraph className="item__heading paragraph--bold">Verwendung der Personaldaten</Paragraph>
				...
				<div className="paragraphs__item item">
					<Paragraph className="item__heading paragraph--bold">An wen gehen die Personendaten weiter?</Paragraph>
				...
				<div className="paragraphs__item item">
					<Paragraph className="item__heading paragraph--bold">Dauer der Aufbewahrung von Personendaten</Paragraph>
				...
				<div className="paragraphs__item item">
					<Paragraph className="item__heading paragraph--bold">Protokollierung</Paragraph>
				...
				<div className="paragraphs__item item">
					<Paragraph className="item__heading paragraph--bold">Zweck und Dauer der Datenverarbeitung</Paragraph>
				...
				<div className="paragraphs__item item">
					<Paragraph className="item__heading paragraph--bold">Widerspruchs- und Beseitigungsmöglichkeit</Paragraph>
				...
				<div className="paragraphs__item item">
					<Paragraph className="item__heading paragraph--bold">Cookies</Paragraph>
				...
				<div className="paragraphs__item item">
					<Paragraph className="item__heading paragraph--bold">Haftung für Links</Paragraph>
				...
				<div className="paragraphs__item item">
					<Paragraph className="item__heading paragraph--bold">Aktualität und Änderung dieser Datenschutzerklärung</Paragraph>
