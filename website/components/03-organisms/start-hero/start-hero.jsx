...
const StartHero = () => {
	...
	useEffect(() => {
		const context = gsap.context(() => {
			...
			themeTimelineRef.current.to('.start-hero .background-video__video', { autoAlpha: '0', duration: 0 }, 0);
			...
			themeTimelineRef.current.to(`.start-hero .background-video__video[data-theme="${ theme }"]`, { autoAlpha: 1, duration: 0 }, 0);
