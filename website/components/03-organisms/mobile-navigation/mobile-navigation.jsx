...
const MobileNavigation = () => {
	...
	useEffect(() => {
		const context = gsap.context(() => {
			...
			menuTimelineRef.current.to('.mobile-navigation .navigation__menu', { left: 0, duration: 0.2 });
		}, mobileNavigationRef);
		...
		<Section className="mobile-navigation" ref={ mobileNavigationRef }>
			...
			<div className="mobile-navigation__bar bar">
				<Link className="bar__logo-link" href="/" onClick={ (event) => { return handleLinkClick(event, '/'); } }>
					<Image className="bar__logo" src="/logos/logo-wespi-sins-bw-minimal.svg" alt="Samira Haas" width="140" height="40" priority />
				</Link>
			...
			<div className="navigation__menu menu">
				...
				<div className="menu__contact-details contact-details">
				...
				<div className="menu__business-hours business-hours">
