...
const ContactInfo = () => {
	...
	return (
		<Section className="contact-info">
			<div className="contact-info__intro intro">
			...
			<div className="contact-info__contact-details contact-details">
			...
			<div className="contact-info__business-hours business-hours">
