...
const Action = ({ className, children, symbol, onClick }) => {
		...
		<div className="action" onClick={ onClick }>
			...
			{ symbol === 'add-circle' ? (
				<svg className="action__icon" width="20" height="20" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path d="M11 7V15M7 11H15M21 11C21 16.5228 16.5228 21 11 21C5.47715 21 1 16.5228 1 11C1 5.47715 5.47715 1 11 1C16.5228 1 21 5.47715 21 11Z" stroke="#9E453E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
				</svg>
			) : null }
			{ symbol === 'close-circle' ? (
			...
			<Paragraph className={ `${ className } action__label` }>{ children }</Paragraph>
		</div>
	);
